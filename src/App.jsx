      ...
      <BrowserRouter>
        <div className={`${theme}`}>
          ...
          <Routes>
            ...
            <Route
              path="/privacypolicy"
              element={<PrivacyPolicy theme={theme}></PrivacyPolicy>}
            ></Route>
            <Route
              path="/termandconditions"
              element={<TermAndConditions theme={theme}></TermAndConditions>}
            ></Route>
            <Route
              path="/contactus"
              element={<ContactUs theme={theme}></ContactUs>}
            ></Route>
            <Route
              path="/profile"
              element={
            ...
            <Route
              ...
              element={<CancellationPolicy theme={theme}></CancellationPolicy>}
            ></Route>
          </Routes>
